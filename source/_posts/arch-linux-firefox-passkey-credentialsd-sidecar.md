...
因为之前经历了微软盗号事件，不熟悉的可以去看看这篇博文：[记录一次微软账号被盗的经历](https://blog.plfjy.top/ms-account-hacked/)，最近研究出了国外平台账号安全的一个极佳解法 —— Passkey + TOTP，但是问题来了，Passkey 我主要存在 iCloud KeyChain 上，一般我都是手机扫码然后 Face ID 使用的，Windows 上都没有大量存，更别说 Linux 了同时目前能找到的教程也都是怎么在 Linux 上存储 Passkey 的，没有用手机扫码使用 Passkey 的
