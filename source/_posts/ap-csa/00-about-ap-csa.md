...
我接下来将会以我自己重组过的顺序来把 Java 和面向对象编程的本质讲明白，这绝对是你没有在任何书上见过的阐述顺序和串讲方式

### 考试大纲

在经历了 2025 年改版之后，AP Computer Science A 的考试大纲由原来的 10 个 Unit 变为了 4 个大的 Unit，总体考察内容没有太大变化，相比之前的大纲新增了数据读写、数据类型转换、IO 异常之类的内容，总体不会太难

![syllabus](00-about-ap-csa/syllabus.png)
